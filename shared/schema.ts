...
export const commands = pgTable("commands", {
  ...
  actionType: text("action_type").notNull(), // pin_message, unpin_message, unpin_all_messages, set_title, remove_title, mute, kick, ban, delete_message, create_invite_link, set_group_name, set_group_description, delete_group_description
